...
{% include elements/figure.html name="1.jpg" caption="Numerous test cases and iterations were performed to guage how dune movement took place under various different conditions" credit="(image from thesis documents)" %}

![caption](/1.jpg "extra note")
...
{% include elements/figure.html name="4.png" caption="A cellular automata based model of dune movement was employed to model dune drift" credit="(image from thesis documents)" %}

{% include elements/figure.html name="3.png" caption="Strategies for intervening into particular dune types were developed using vegetation and small structures" credit="(image from thesis documents)" %}
...
{% include elements/figure.html name="2.png" caption="Larger structures were used to obstruct and reform dune drift at key points" credit="(image from thesis documents)" %}
