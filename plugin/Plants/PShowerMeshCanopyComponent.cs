...
namespace groundhog
{
    public class GroundhogShowerCanopyMeshComponent : GroundHogComponent
    {
        public List<Color> allColours;
        public List<Mesh> canopyMeshes;
        public List<GH_String> allLabels;

        public GroundhogShowerCanopyMeshComponent()
            : base("Plant Appearance (canopy mesh)", "Shower (canopy mesh)", "Simulate the appearance of a particular plant instance's canopy using a mesh between canopy and trunk", "Groundhog", "Flora")
        {
        }
