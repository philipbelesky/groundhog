...
namespace groundhog
{
    public class GroundhogFieldVisualisationGridComponent : GroundHogComponent
    {
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddCurveParameter("Bounds", "B",
                "Curve boundary to constraint the visualisation to a certain area", GH_ParamAccess.item);
            pManager[1].Optional = true;

            pManager.AddNumberParameter("Domain Start", "DS", "Starting value representing the 'bottom' value",
                GH_ParamAccess.item, 0.0);
            pManager[2].Optional = true;

            pManager.AddNumberParameter("Domain End", "DE", "Ending value representing the 'top' value",
